function [Header,Data] = LoadAmiraFile(Pathname)
...
%        (4) Shawn Stapleton, Nov 2012
    ...
    if (strcmp(AsciiData, '# AmiraMesh BINARY-LITTLE-ENDIAN 2.1')==0 ) && (strcmp(AsciiData, '# Avizo BINARY-LITTLE-ENDIAN 2.1')==0 )
    ...
    % MODIFIED AND HARDCODED FOR 3 COMPONENT VECTOR ONLY
    Data = reshape(Data,3,Header.xSize,Header.ySize,Header.zSize);    
return
